...
/// Contrôleur de signature tactile : accumule le tracé et l'exporte en PNG
/// transparent (CDC §11.6 — signature → fichier PNG → upload multipart).
class SoeSignatureController extends ChangeNotifier {
...
/// Zone de signature tactile reliée à un [SoeSignatureController].
class SoeSignaturePad extends StatelessWidget {
  const SoeSignaturePad({
    super.key,
  ...
  final SoeSignatureController controller;
